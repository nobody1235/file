...
<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-logo" style="width:350px;font-size: 22px;text-align: left;text-indent: 20px;" ><h5>欢迎进入文档分享平台</h5></div>
		<ul class="layui-nav layui-layout-right">
			<li class="layui-nav-item">
				<a href="javascript:;">
					<img src="http://t.cn/RCzsdCq" class="layui-nav-img">
<%--					${tbl_bom.bom_name}--%>${loginUser.username}
				</a>
				<dl class="layui-nav-child">
					<dd><a href="${pageContext.request.contextPath}/servlet/front/exit">注销</a></dd>
				</dl>
			</li>
		</ul>
	</div>
